...
facility1 = Facility.create!(name: 'スパメッツァおおたか 竜泉寺の湯',
                             address: '千葉県 流山市',
...
facility2 = Facility.create!(name: '東京豊洲 万葉倶楽部',
                             address: '東京都 江東区',
...
facility3 = Facility.create!(name: 'RAKU SPA 1010 神田',
                             address: '東京都 千代田区',
                             ...
                             price: 1220)
facility4 = Facility.create!(name: '湯乃泉 草加健康センター',
                             address: '埼玉県 草加市',
                             ...
                             price: 950)
facility5 = Facility.create!(name: 'ROOFTOP',
                             address: '東京都 杉並区',
